...
public class VeVnfmemQueryPackageDataCreation implements
        CallExecutionDataRetriever {

    private static final Logger LOGGER = LoggerFactory
            .getLogger(VeVnfmemQueryPackageDataCreation.class);
    ...
    public CallExecutionData getCallExecutionData(
        ...
        final VnflcmServiceData vnflcmServiceData = getServiceData(processQueryPackageData);
        final CallExecutionData completeData = new CallExecutionData();
        LOGGER.info("Start OrVnfmQueryPackageDataCreation.getCallExecutionData... ");
        ...
        LOGGER.info("Fetch Query Package  Data successfully", this);
        return completeData;
    }
    ...
    private VnflcmServiceData getServiceData(final ProcessDataDto processDataDto) {
        ...
        serviceData.setVnfId(processDataDto.getPackageManagementListenerData().getVnfdId());
    ...
    private NbiData fetchOrvnfmData() throws NfvoCallException {
        LOGGER.info("Start OrVnfmQueryPackageDataCreation.fetchOrvnfmData... ");
        final NfvoConfigHelper nfvoConfigHelper = new NfvoConfigHelper();
        final NfvoConfig nfvoConfigData = nfvoConfigHelper.readNfvoConfig(null, null); // LcmOccId will not be available during packagemanagement
        ...
        LOGGER.info("End OrVnfmQueryPackageDataCreation.fetchOrvnfmData ");
        return orvnfmData;
    }
