...
public class PackageManagementResponseDto extends ResponseDTO implements Serializable{
    ...
    public String toString() {
        return "PackageManagementResponseDto [vnfdId=" + vnfdId+ "responseCode=" + responseCode+ "onboardedVnfPkgInfo.id=" + onboardedVnfPkgInfo.id + "]";
        }
