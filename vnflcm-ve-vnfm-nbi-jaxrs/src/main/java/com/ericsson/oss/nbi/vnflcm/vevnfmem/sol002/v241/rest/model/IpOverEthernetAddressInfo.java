...
public class IpOverEthernetAddressInfo {
    ...
    public IpOverEthernetAddressInfo withMacAddress(final String value) {
        this.macAddress = value;
        return this;
    }
    ...
    public IpOverEthernetAddressInfo withIpAddresses(final List<IpAddresses> value) {
    ...
    public String toString() {
        return "IpOverEthernetAddressInfo [macAddress=" + macAddress + ", ipAddresses=" + ipAddresses + "]";
    }
}
